...
<FingerprintSpinner v-if = "this.loading == true"></FingerprintSpinner>
  <div class="panelCommentairesAttente" v-if = "this.loading == false">
...
export default {
  ...
  mounted(){ // Obtenir tout les commentaires pas encore validés 
    axios
    .get('http://localhost:3000/api/stuff/admin/panel_commentaires_attente/', {
        headers: {
